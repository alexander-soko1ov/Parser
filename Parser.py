...
# add_datetime = datetime.datetime(1+year, 1+month, 1+day, hour, minute)
# HUINYA = datetime.datetime(1, 1, 1)
# totay_datetime = datetime.timedelta(1+year, 1+month, 1+day, hour, minute)
# totay_answer_datetime = totay_datetime - HUINYA
# print(totay_datetime)
# answer_time = add_datetime + totay_datetime - HUINYA
# print(answer_time)

add_datetime = datetime.timedelta(1+year, 1+month, 1+day, hour, minute)
today_datetime = datetime.datetime.today()

print(add_datetime + today_datetime)
